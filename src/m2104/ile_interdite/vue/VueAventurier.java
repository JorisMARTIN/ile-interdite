...
public class VueAventurier {
    ...
    public VueAventurier(IHM ihm, Integer id, String nomJoueur, String nomAventurier, Integer num, Integer nbAventuriers, Color couleurActive, Color couleurInactive) {
        ...
        this.btnDonner = creerBouton(3, "Donner", Utils.Commandes.DONNER, "Donner une carte Ã  un autre joueur") ;
        ...
        this.btnPrendre = creerBouton(4, "Prendre", Utils.Commandes.RECUPERER_TRESOR, "Récupérer le trÃ©sor de la tuile courante") ;
    ...
    // ====================================================== Activation de la carte Ã  son tour
    public void activer() {
