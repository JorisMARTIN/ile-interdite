...
public class Message implements Serializable {
    ...
    private Message(Utils.Commandes commande, Integer idAventurier, Integer idCarte, Utils.Tresor tresor, Integer idTuile, Integer nbJoueurs, Grille grille) {
    ...
    public static Message initialiser_Grille(Grille grille) {
    	return new Message(Utils.Commandes.INITIALISER_GRILLE, null, null, null, null, null, grille);
    }
