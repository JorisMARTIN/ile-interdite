...
public class Utils {
    ...
    /**
     * Permet de poser une question Ã  laquelle l'utilisateur rÃ©pond par oui ou non
     * @param question texte Ã  afficher
     * @return true si l'utilisateur rÃ©pond oui, false sinon
     */
